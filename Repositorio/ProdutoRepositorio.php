...
class ProdutoRepositorio
{
    ...
    {
        $sql = "SELECT * FROM produtos where tipo = 'Bolos' 
        ORDER BY preco";
    ...
    public function listarBolosPorId($id)
    {
        $sql = "SELECT * FROM produtos WHERE tipo = 'Bolos' 
    ...
    public function listarTortaPorId($id)
    {
        $sql = "SELECT * FROM produtos WHERE tipo = 'Torta' 
            AND id = ? ORDER BY preco LIMIT 1";
    ...
    public function listarDocesPorId($id)
    {
        $sql = "SELECT * FROM produtos WHERE tipo = 'Doces' 
            AND id = ? ORDER BY preco LIMIT 1";
    ...
    public function listarCupcakePorId($id)
    {
        $sql = "SELECT * FROM produtos WHERE tipo = 'Cupcake' 
            AND id = ? ORDER BY preco LIMIT 1";
    ...
    public function listarTorta()
    {
        $sql = "SELECT * FROM produtos where tipo = 'Tortas' 
        ORDER BY preco";
        $result = $this->conn->query($sql);
    ...
    public function listarCupCake()
    {
        $sql = "SELECT * FROM produtos where tipo = 'CupCakes' 
        ORDER BY preco";
        $result = $this->conn->query($sql);
